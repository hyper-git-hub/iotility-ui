...
@Component({selector:'app-violations-page',imports:[RouterLink,RouterLinkActive,RouterOutlet,StatCard],templateUrl:'./violations-page.html',styleUrl:'./violations-page.css'})
