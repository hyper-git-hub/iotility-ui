...
export const DASHBOARD_WIDGETS: DashboardWidget[] = [
  ...
  { id: 'FCUT', name: 'CO2 & Fuel Efficiency', description: 'CO2 and fuel usage trend', tab: 'overview' },
  { id: 'FCT', name: 'Fuel Consumption', description: 'Fuel consumption by vehicle type', tab: 'overview' },
